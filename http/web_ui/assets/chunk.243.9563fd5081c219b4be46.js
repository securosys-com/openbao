"use strict";(globalThis.webpackChunk_ember_auto_import_=globalThis.webpackChunk_ember_auto_import_||[]).push([[243],{1243(e,t,o){o.r(t),o.d(t,{default:()=>_})
...
e&&e.blur&&e!==document.body&&e.blur()}function s(e,t){for(var o=0;o<e.length;++o)if(e[o]===t)return!0
return!1}function l(e){return!(!e||!e.hasAttribute("method"))&&"dialog"===e.getAttribute("method").toLowerCase()}function d(e){var t=["button","input","keygen","select","textarea"].map(function(e){return e+":not([disabled])"})
...
try{r=document.querySelectorAll(a.selectorText)}catch(e){}if(r&&s(r,e)){var l=a.style.getPropertyValue("top"),d=a.style.getPropertyValue("bottom")
...
if(f){var b=f.get
f.get=function(){return l(this)?"dialog":b.call(this)}
var v=f.set
...
if("composedPath"in e&&(t=e.composedPath().shift()||t),t&&l(t.form)){if(!("submit"===t.type&&["button","input"].indexOf(t.localName)>-1)){if("input"!==t.localName||"image"!==t.type)return
...
HTMLFormElement.prototype.submit=function(){if(!l(this))return y.call(this)
var e=a(this)
e&&e.close()}}const _=g}}])
