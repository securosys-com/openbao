/*! For license information please see chunk.280.5d7197cf060fbbfade69.js.LICENSE.txt */
(globalThis.webpackChunk_ember_auto_import_=globalThis.webpackChunk_ember_auto_import_||[]).push([[280],{8280(e,t,n){var r
...
function N(e){var t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=t&&R("array",e)?[]:{}
...
function F(e,t){return e===t}function D(e,t){return e===t||e.valueOf()===t.valueOf()}function P(e){var t=Object.getPrototypeOf(e)
return t&&null!==t.constructor?e.constructor:Object}function H(e){return"flags"in e?e.flags:e.toString().match(/[gimuy]*$/)[0]}var B={undefined:F,null:F,boolean:D,number:function(e,t){return e===t||e.valueOf()===t.valueOf()||isNaN(e.valueOf())&&isNaN(t.valueOf())},string:D,symbol:F,date:D,nan:function(){return!0},regexp:function(e,t){return e.source===t.source&&H(e)===H(t)},function:F,array:function(e,t){if(e.length!==t.length)return!1
...
t.forEach(function(t,n){if(!i){var s=Q
Q=[],B.array([t,n],[e,r])&&(i=!0),Q=s}}),i||(n=!1)}}),n}},z={undefined:F,null:F,boolean:F,number:function(e,t){return e===t||isNaN(e)&&isNaN(t)},string:F,symbol:F,function:F,object:function(e,t){if(Q.some(function(n){return n.a===e&&n.b===t}))return!0
Q.push({a:e,b:t})
var n=I(e),r=I(t)
...
n--}return!0}var W={altertitle:!0,collapse:!0,countStepsAsOne:!1,failOnZeroTests:!0,filter:void 0,testFilter:null,maxDepth:5,module:void 0,moduleId:void 0,reorder:!0,reporters:{},requireExpects:!1,scrolltop:!0,storage:w,testId:void 0,urlConfig:[],currentModule:{name:"",tests:[],childModules:[],testsRun:0,testsIgnored:0,hooks:{before:[],beforeEach:[],afterEach:[],after:[]}},globalHooks:{},pq:null,_event_listeners:Object.create(null),_event_memory:{},_deprecated_timeout_shown:!1,_deprecated_countEachStep_shown:!1,blocking:!0,callbacks:{},modules:[],queue:[],stats:{all:0,bad:0,testCount:0}}
...
u&&"function"==typeof u.then&&ne.warn("Returning a promise from a module callback is not supported. Instead, use hooks for async behavior. This will become an error in QUnit 3.0.")}finally{ie.pop(),W.currentModule=r.parentModule||a}}}function le(e){for(var t=null,n=e.suiteReport;n;){n.tests.length=0
var r=n.childSuites.indexOf(t);-1===r?n.childSuites.length=0:(n.childSuites.splice(0,r),n.childSuites.splice(1)),n===se?n=null:(t=n,n=(e=e.parentModule)&&e.suiteReport||se)}}var ce=!1
function fe(e,t,n){var r,i=ce&&(r=W.modules.filter(function(e){return!e.ignored}).map(function(e){return e.moduleId}),!ie.some(function(e){return r.includes(e.moduleId)}))
ue(e,t,n,{ignored:i})}fe.only=function(){ce||(W.modules.length=0,W.queue.length=0,le(W.currentModule),W.currentModule.ignored=!0),ce=!0,ue.apply(void 0,arguments)},fe.skip=function(e,t,n){ce||ue(e,t,n,{skip:!0})},fe.if=function(e,t,n,r){ce||ue(e,n,r,{skip:!t})},fe.todo=function(e,t,n){ce||ue(e,t,n,{todo:!0})}
...
for(var s=!0,o=0;o<r.length;o++){var a=r[o],u=de&&-1!==a.indexOf(de)||-1!==a.indexOf("node:internal/")||a.match(/^\s+at .+\(internal[^)]*\)$/)||a.match(/^\s+at .+\([a-z]+\.js[:\d]*\)$/)
u||(s=!1),s||i.push(u?t(a):a)}return i.join("\n")}function pe(e,t){if(t=void 0===t?4:t,e&&e.stack){var n=e.stack.split("\n")
if(/^error$/i.test(n[0])&&n.shift(),de){for(var r=[],i=t;i<n.length&&-1===n[i].indexOf(de);i++)r.push(n[i])
if(r.length)return r.join("\n")}return n[t]}}function ge(e){var t=new Error
if(!t.stack)try{throw t}catch(e){t=e}return pe(t,e)}var me=function(){function e(t){s(this,e),this.test=t}return a(e,[{key:"timeout",value:function(e){if("number"!=typeof e)throw new Error("You must pass a number as the duration to assert.timeout")
...
return n instanceof e||(n=r.assert),n.test.pushResult(t)}},{key:"ok",value:function(e,t){t||(t=e?"okay":"failed, expected argument to be truthy, was: ".concat(te.parse(e))),this.pushResult({result:!!e,actual:e,expected:!0,message:t})}},{key:"notOk",value:function(e,t){t||(t=e?"failed, expected argument to be falsy, was: ".concat(te.parse(e)):"okay"),this.pushResult({result:!e,actual:e,expected:!1,message:t})}},{key:"true",value:function(e,t){this.pushResult({result:!0===e,actual:e,expected:!0,message:t})}},{key:"false",value:function(e,t){this.pushResult({result:!1===e,actual:e,expected:!1,message:t})}},{key:"equal",value:function(e,t,n){this.pushResult({result:t==e,actual:e,expected:t,message:n})}},{key:"notEqual",value:function(e,t,n){this.pushResult({result:t!=e,actual:e,expected:t,message:n,negative:!0})}},{key:"propEqual",value:function(e,t,n){e=N(e),t=N(t),this.pushResult({result:Y(e,t),actual:e,expected:t,message:n})}},{key:"notPropEqual",value:function(e,t,n){e=N(e),t=N(t),this.pushResult({result:!Y(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"propContains",value:function(e,t,n){e=j(e,t),t=N(t,!1),this.pushResult({result:Y(e,t),actual:e,expected:t,message:n})}},{key:"notPropContains",value:function(e,t,n){e=j(e,t),t=N(t),this.pushResult({result:!Y(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"deepEqual",value:function(e,t,n){this.pushResult({result:Y(e,t),actual:e,expected:t,message:n})}},{key:"notDeepEqual",value:function(e,t,n){this.pushResult({result:!Y(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"strictEqual",value:function(e,t,n){this.pushResult({result:t===e,actual:e,expected:t,message:n})}},{key:"notStrictEqual",value:function(e,t,n){this.pushResult({result:t!==e,actual:e,expected:t,message:n,negative:!0})}},{key:"throws",value:function(t,n,r){var i=u(ve(n,r,"throws"),2)
n=i[0],r=i[1]
var s=this instanceof e&&this.test||W.current
if("function"==typeof t){var o,a=!1
s.ignoreGlobalErrors=!0
try{t.call(s.testEnvironment)}catch(e){o=e}if(s.ignoreGlobalErrors=!1,o){var l=u(be(o,n,r),3)
...
return o.call(t,function(){s.assert.pushResult({result:!1,message:'The promise returned by the `assert.rejects` callback in "'+s.testName+'" did not reject.',actual:t}),a()},function(e){var t,i=u(be(e,n,r),3)
...
function ve(e,t,n){var r=I(e)
if("string"===r){if(void 0===t)return t=e,[e=void 0,t]
throw new Error("assert."+n+" does not accept a string value for the expected argument.\nUse a non-string object value (e.g. RegExp or validator function) instead if necessary.")}if(e&&"regexp"!==r&&"function"!==r&&"object"!==r)throw new Error("Invalid expected value type ("+r+") provided to assert."+n+".")
return[e,t]}function be(e,t,n){var r=!1,i=I(t)
...
var ye=["error","runStart","suiteStart","testStart","assertion","testEnd","suiteEnd","runEnd"],ke=["error","runEnd"]
function we(e,t){if("string"!=typeof e)throw new TypeError("eventName must be a string when emitting an event")
for(var n=W._event_listeners[e],r=n?l(n):[],i=0;i<r.length;i++)r[i](t)
q(e,ke)&&(W._event_memory[e]=t)}var xe="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{}
...
s._unhandledRejectionFn=function(e){"undefined"!=typeof console&&console&&console.warn("Possible Unhandled Promise Rejection:",e)},Te.exports=s}else Te.exports=e.Promise
...
this.testId=O(this.module.name,this.testName),++qe.count,this.errorForStack=new Error,this.callback&&this.callback.validTest&&(this.errorForStack.stack=void 0),this.testReport=new Se(this.testName,this.module.suiteReport,{todo:this.todo,skip:this.skip,valid:this.valid()}),this.module.tests.push({name:this.testName,testId:this.testId,skip:!!this.skip}),this.skip?(this.callback=function(){},this.async=!1,this.expected=0):this.assert=new me(this)}}function Ne(){if(!W.current)throw new Error("pushFailure() assertion outside test context, in "+ge(2))
var e=W.current
...
W.pollution.push(e)}}qe.count=0,qe.prototype={get stack(){return pe(this.errorForStack,this.stackOffset)},before:function(){var e=this,t=this.module,n=function(e){for(var t=e,n=[];t&&0===t.testsRun;)n.push(t),t=t.parentModule
return n.reverse()}(t),r=Ce.resolve()
return n.forEach(function(e){r=r.then(function(){return e.stats={all:0,bad:0,started:_.now()},we("suiteStart",e.suiteReport.start(!0)),_e("moduleStart",{name:e.name,tests:e.tests})})}),r.then(function(){return W.current=e,e.testEnvironment=M({},t.testEnvironment),e.started=_.now(),we("testStart",e.testReport.start(!0)),_e("testStart",{name:e.testName,module:t.name,testId:e.testId,previousFailure:e.previousFailure}).then(function(){W.pollution||je()})})},run:function(){if(W.current=this,W.notrycatch)e(this)
else try{e(this)}catch(e){this.pushFailure("Died on test #"+(this.assertions.length+1)+": "+(e.message||e)+"\n"+this.stack,pe(e,0)),je(),W.blocking&&Qe(this)}function e(e){var t
t=e.withData?e.callback.call(e.testEnvironment,e.assert,e.data):e.callback.call(e.testEnvironment,e.assert),e.resolvePromise(t),0===e.timeout&&e.pauses.size>0&&Ne("Test did not finish synchronously even though assert.timeout( 0 ) was used.",ge(2))}},after:function(){!function(){var e=W.pollution
je()
...
else try{r=e.call(n.testEnvironment,n.assert)}catch(e){return void n.pushFailure("Global "+t+" failed on "+n.testName+": "+A(e),pe(e,0))}n.resolvePromise(r,t)}},queueHook:function(e,t,n){var r=this,i=function(){var n=e.call(r.testEnvironment,r.assert)
...
else try{i()}catch(e){r.pushFailure(t+" failed on "+r.testName+": "+(e.message||e),pe(e,0))}}},hooks:function(e){var t=[]
...
s?He(n):function(e){for(e.testsRun++;e=e.parentModule;)e.testsRun++}(n),u&&(a?u.setItem("qunit-test-"+r+"-"+i,a):u.removeItem("qunit-test-"+r+"-"+i)),we("testEnd",this.testReport.end(!0)),this.testReport.slimAssertions()
var f=this
return _e("testDone",{name:i,module:r,skipped:s,todo:o,failed:a,passed:this.assertions.length-a,total:this.assertions.length,runtime:s?0:this.runtime,assertions:this.assertions,testId:this.testId,get source(){return f.stack}}).then(function(){if(Pe(n)){for(var e=[n],t=n.parentModule;t&&Pe(t);)e.push(t),t=t.parentModule
var r=Ce.resolve()
return e.forEach(function(e){r=r.then(function(){return function(e){for(var t=[e];t.length;){var n=t.shift()
n.hooks={},t.push.apply(t,l(n.childModules))}return we("suiteEnd",e.suiteReport.end(!0)),_e("moduleDone",{name:e.name,tests:e.tests,failed:e.stats.bad,passed:e.stats.all-e.stats.bad,total:e.stats.all,runtime:Math.round(_.now()-e.stats.started)})}(e)})}),r}}).then(function(){W.current=void 0})},preserveTestEnvironment:function(){this.preserveEnvironment&&(this.module.testEnvironment=this.testEnvironment,this.testEnvironment=M({},this.module.testEnvironment))},queue:function(){var e=this
if(this.valid()){var t=W.storage&&+W.storage.getItem("qunit-test-"+this.module.name+"-"+this.testName),n=W.reorder&&!!t
this.previousFailure=!!t,W.pq.add(function(){return[function(){return e.before()}].concat(l(e.hooks("before")),[function(){e.preserveTestEnvironment()}],l(e.hooks("beforeEach")),[function(){e.run()}],l(e.hooks("afterEach").reverse()),l(e.hooks("after").reverse()),[function(){e.after()},function(){return e.finish()}])},n)}else He(this.module)},pushResult:function(e){if(this!==W.current){var t=e&&e.message||"",n=this&&this.testName||""
...
if(C.call(e,"expected")&&(r.expected=e.expected),!e.result){var i=e.source||ge()
i&&(r.source=i)}this.logAssertion(r),this.assertions.push({result:!!e.result,message:e.message})},pushFailure:function(e,t){if(!(this instanceof qe))throw new Error("pushFailure() assertion outside test context, was "+ge(2))
this.pushResult({result:!1,message:e||"error",source:t})},logAssertion:function(e){_e("log",e)
var t={passed:e.result,actual:e.actual,expected:e.expected,message:e.message,stack:e.source,todo:e.todo}
this.testReport.pushAssertion(t),we("assertion",t)},internalResetTimeout:function(e){m(W.timeout),W.timeout=g(W.timeoutHandler(e),e)},internalStop:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:1
W.blocking=!0
var t,n=this,r=this.nextPauseId++,i={cancelled:!1,remaining:e}
return n.pauses.set(r,i),g&&("number"==typeof n.timeout?t=n.timeout:"number"==typeof W.testTimeout&&(t=W.testTimeout),"number"==typeof t&&t>0?(W.timeoutHandler=function(e){return function(){W.timeout=null,i.cancelled=!0,n.pauses.delete(r),n.pushFailure("Test took longer than ".concat(e,"ms; test timed out."),ge(2)),Qe(n)}},m(W.timeout),W.timeout=g(W.timeoutHandler(t),t)):(m(W.timeout),W.timeout=g(function(){W.timeout=null,W._deprecated_timeout_shown||(W._deprecated_timeout_shown=!0,ne.warn('Test "'.concat(n.testName,'" took longer than 3000ms, but no timeout was set. Set QUnit.config.testTimeout or call assert.timeout() to avoid a timeout in QUnit 3. https://qunitjs.com/api/config/testTimeout/')))},3e3))),function(){if(!i.cancelled){if(void 0===W.current)throw new Error("Unexpected release of async pause after tests finished.\n"+"> Test: ".concat(n.testName," [async #").concat(r,"]"))
...
n.pushFailure(r,pe(e,0)),je(),Qe(n)})}}},valid:function(){if(this.callback&&this.callback.validTest)return!0
...
if(n){if(!this.regexFilter(!!n[1],n[2],n[3],r))return!1}else if(!this.stringFilter(t,r))return!1}if("function"==typeof W.testFilter){var i={testId:this.testId,testName:this.testName,module:this.module.name,skip:!!this.skip}
try{return!!W.testFilter(i)}catch(e){return ne.warn("Error in QUnit.config.testFilter callback: ",e),!1}}return!0},regexFilter:function(e,t,n,r){return new RegExp(t,n).test(r)!==e},stringFilter:function(e,t){e=e.toLowerCase(),t=t.toLowerCase()
var n="!"!==e.charAt(0)
return n||(e=e.slice(1)),-1!==t.indexOf(e)?n:!n}}
var Me=!1
function Ie(e){Me||W.currentModule.ignored||new qe(e).queue()}function Re(e){W.currentModule.ignored||(Me||(W.queue.length=0,le(W.currentModule),Me=!0),new qe(e).queue())}function Oe(e,t){Ie({testName:e,callback:t})}function Ae(e,t){return"".concat(e," [").concat(t,"]")}var Le=/[\x00-\x1F\x7F\xA0]/
function Ue(e,t){if(Array.isArray(e))for(var n=0;n<e.length;n++){var r=e[n],i=f(r),s=n
if("string"===i&&r.length<=40&&!Le.test(r)&&!/\s*\d+: /.test(r))s=r
else if("string"===i||"number"===i||"boolean"===i||"undefined"===i||null===r){var o=String(r)
Le.test(o)||(s=n+": "+(o.length<=30?o:o.slice(0,29)+"…"))}t(r,s)}else{if("object"!==f(e)||null===e)throw new Error("test.each() expects an array or object as input, but\nfound ".concat(f(e)," instead."))
for(var a in e)t(e[a],a)}}function Qe(e){e.pauses.forEach(function(e){e.cancelled=!0}),e.pauses.clear(),Fe(e)}function Fe(e){e.pauses.size>0||(g?(m(W.timeout),W.timeout=g(function(){e.pauses.size>0||(m(W.timeout),W.timeout=null,W.blocking=!1,W.pq.advance())})):(W.blocking=!1,W.pq.advance()))}function De(e){for(var t=[].concat(e.tests),n=l(e.childModules);n.length;){var r=n.shift()
t.push.apply(t,r.tests),n.push.apply(n,l(r.childModules))}return t}function Pe(e){return e.testsRun+e.testsIgnored===De(e).length}function He(e){for(e.testsIgnored++;e=e.parentModule;)e.testsIgnored++}M(Oe,{todo:function(e,t){Ie({testName:e,callback:t,todo:!0})},skip:function(e){Ie({testName:e,skip:!0})},if:function(e,t,n){Ie({testName:e,callback:n,skip:!t})},only:function(e,t){Re({testName:e,callback:t})},each:function(e,t,n){Ue(t,function(t,r){Ie({testName:Ae(e,r),callback:n,withData:!0,stackOffset:5,data:t})})}}),Oe.todo.each=function(e,t,n){Ue(t,function(t,r){Ie({testName:Ae(e,r),callback:n,todo:!0,withData:!0,stackOffset:5,data:t})})},Oe.skip.each=function(e,t){Ue(t,function(t,n){Ie({testName:Ae(e,n),stackOffset:5,skip:!0})})},Oe.if.each=function(e,t,n,r){Ue(n,function(n,i){Ie({testName:Ae(e,i),callback:r,withData:!0,stackOffset:5,skip:!t,data:t?n:void 0})})},Oe.only.each=function(e,t,n){Ue(t,function(t,r){Re({testName:Ae(e,r),callback:n,withData:!0,stackOffset:5,data:t})})}
var Be,ze,$e,Ge,Ye=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
s(this,e),this.log=n.log||Function.prototype.bind.call(p.log,p),t.on("error",this.onError.bind(this)),t.on("runStart",this.onRunStart.bind(this)),t.on("testStart",this.onTestStart.bind(this)),t.on("testEnd",this.onTestEnd.bind(this)),t.on("runEnd",this.onRunEnd.bind(this))}return a(e,[{key:"onError",value:function(e){this.log("error",e)}},{key:"onRunStart",value:function(e){this.log("runStart",e)}},{key:"onTestStart",value:function(e){this.log("testStart",e)}},{key:"onTestEnd",value:function(e){this.log("testEnd",e)}},{key:"onRunEnd",value:function(e){this.log("runEnd",e)}}],[{key:"init",value:function(t,n){return new e(t,n)}}])}(),We=b&&void 0!==b.performance&&"function"==typeof b.performance.mark&&"function"==typeof b.performance.measure?b.performance:void 0,Je={measure:We?function(e,t,n){try{We.measure(e,t,n)}catch(e){ne.warn("performance.measure could not be executed because of ",e.message)}}:function(){},mark:We?We.mark.bind(We):function(){}},Ve=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
s(this,e),this.perf=n.perf||Je,t.on("runStart",this.onRunStart.bind(this)),t.on("runEnd",this.onRunEnd.bind(this)),t.on("suiteStart",this.onSuiteStart.bind(this)),t.on("suiteEnd",this.onSuiteEnd.bind(this)),t.on("testStart",this.onTestStart.bind(this)),t.on("testEnd",this.onTestEnd.bind(this))}return a(e,[{key:"onRunStart",value:function(){this.perf.mark("qunit_suite_0_start")}},{key:"onSuiteStart",value:function(e){var t=e.fullName.length
...
Be=Ke.FORCE_COLOR,ze=Ke.NODE_DISABLE_COLORS,$e=Ke.NO_COLOR,Ge=Ke.TERM,Ze=process.stdout&&process.stdout.isTTY}var Xe={enabled:!ze&&null==$e&&"dumb"!==Ge&&(null!=Be&&"0"!==Be||Ze),reset:tt(0,0),bold:tt(1,22),dim:tt(2,22),italic:tt(3,23),underline:tt(4,24),inverse:tt(7,27),hidden:tt(8,28),strikethrough:tt(9,29),black:tt(30,39),red:tt(31,39),green:tt(32,39),yellow:tt(33,39),blue:tt(34,39),magenta:tt(35,39),cyan:tt(36,39),white:tt(37,39),gray:tt(90,39),grey:tt(90,39),bgBlack:tt(40,49),bgRed:tt(41,49),bgGreen:tt(42,49),bgYellow:tt(43,49),bgBlue:tt(44,49),bgMagenta:tt(45,49),bgCyan:tt(46,49),bgWhite:tt(47,49)}
function et(e,t){for(var n,r=0,i="",s="";r<e.length;r++)i+=(n=e[r]).open,s+=n.close,~t.indexOf(n.close)&&(t=t.replace(n.rgx,n.close+n.open))
return i+t+s}function tt(e,t){var n={open:"[".concat(e,"m"),close:"[".concat(t,"m"),rgx:new RegExp("\\x1b\\[".concat(t,"m"),"g")}
return function(t){return void 0!==this&&void 0!==this.has?(~this.has.indexOf(e)||(this.has.push(e),this.keys.push(n)),void 0===t?this:Xe.enabled?et(this.keys,t+""):t+""):void 0===t?((r={has:[e],keys:[n]}).reset=Xe.reset.bind(r),r.bold=Xe.bold.bind(r),r.dim=Xe.dim.bind(r),r.italic=Xe.italic.bind(r),r.underline=Xe.underline.bind(r),r.inverse=Xe.inverse.bind(r),r.hidden=Xe.hidden.bind(r),r.strikethrough=Xe.strikethrough.bind(r),r.black=Xe.black.bind(r),r.red=Xe.red.bind(r),r.green=Xe.green.bind(r),r.yellow=Xe.yellow.bind(r),r.blue=Xe.blue.bind(r),r.magenta=Xe.magenta.bind(r),r.cyan=Xe.cyan.bind(r),r.white=Xe.white.bind(r),r.gray=Xe.gray.bind(r),r.grey=Xe.grey.bind(r),r.bgBlack=Xe.bgBlack.bind(r),r.bgRed=Xe.bgRed.bind(r),r.bgGreen=Xe.bgGreen.bind(r),r.bgYellow=Xe.bgYellow.bind(r),r.bgBlue=Xe.bgBlue.bind(r),r.bgMagenta=Xe.bgMagenta.bind(r),r.bgCyan=Xe.bgCyan.bind(r),r.bgWhite=Xe.bgWhite.bind(r),r):Xe.enabled?et([n],t+""):t+""
...
break
default:t=e}return t}var it=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
s(this,e),this.log=n.log||Function.prototype.bind.call(p.log,p),this.testCount=0,this.started=!1,this.ended=!1,this.bailed=!1,t.on("error",this.onError.bind(this)),t.on("runStart",this.onRunStart.bind(this)),t.on("testEnd",this.onTestEnd.bind(this)),t.on("runEnd",this.onRunEnd.bind(this))}return a(e,[{key:"onRunStart",value:function(e){this.started||(this.log("TAP version 13"),this.started=!0)}},{key:"onError",value:function(e){this.bailed||(this.bailed=!0,this.ended||(this.onRunStart(),this.testCount=this.testCount+1,this.log("not ok ".concat(this.testCount," ").concat(Xe.red("global failure"))),this.logError(e)),this.log("Bail out! "+A(e).split("\n")[0]),this.ended&&this.logError(e))}},{key:"onTestEnd",value:function(e){var t=this
this.testCount=this.testCount+1,"passed"===e.status?this.log("ok ".concat(this.testCount," ").concat(e.fullName.join(" > "))):"skipped"===e.status?this.log("ok ".concat(this.testCount," ").concat(Xe.yellow(e.fullName.join(" > "))," # SKIP")):"todo"===e.status?(this.log("not ok ".concat(this.testCount," ").concat(Xe.cyan(e.fullName.join(" > "))," # TODO")),e.errors.forEach(function(e){return t.logAssertion(e,"todo")})):(this.log("not ok ".concat(this.testCount," ").concat(Xe.red(e.fullName.join(" > ")))),e.errors.forEach(function(e){return t.logAssertion(e)}))}},{key:"onRunEnd",value:function(e){this.ended=!0,this.log("1..".concat(e.testCounts.total)),this.log("# pass ".concat(e.testCounts.passed)),this.log("# ".concat(Xe.yellow("skip ".concat(e.testCounts.skipped)))),this.log("# ".concat(Xe.cyan("todo ".concat(e.testCounts.todo)))),this.log("# ".concat(Xe.red("fail ".concat(e.testCounts.failed))))}},{key:"logAssertion",value:function(e,t){var n="  ---"
if(n+="\n  message: ".concat(nt(e.message||"failed")),n+="\n  severity: ".concat(nt(t||"failed")),(void 0!==e.expected||void 0!==e.actual)&&(n+="\n  actual  : ".concat(nt(e.actual)),n+="\n  expected: ".concat(nt(e.expected))),e.stack){var r=he(e.stack,Xe.grey)
r.length&&(n+="\n  stack: ".concat(nt(r+"\n")))}n+="\n  ...",this.log(n)}},{key:"logError",value:function(e){var t="  ---"
if(t+="\n  message: ".concat(nt(A(e))),t+="\n  severity: ".concat(nt("failed")),e&&e.stack){var n=he(e.stack,Xe.grey,e.toString())
n.length&&(t+="\n  stack: ".concat(nt(n+"\n")))}t+="\n  ...",this.log(t)}}],[{key:"init",value:function(t,n){return new e(t,n)}}])}(),st={console:Ye,perf:Ve,tap:it}
function ot(e){return function(t){W.globalHooks[e]||(W.globalHooks[e]=[]),W.globalHooks[e].push(t)}}var at={beforeEach:ot("beforeEach"),afterEach:ot("afterEach")},ut=a(function e(t){s(this,e),this.test=t,this.priorityCount=0,this.unitSampler=null,this.taskQueue=[],this.finished=!1},[{key:"advance",value:function(){this.advanceTaskQueue(),this.taskQueue.length||W.blocking||W.current||this.advanceTestQueue()}},{key:"advanceTaskQueue",value:function(){var e=_.now()
...
Ce.resolve(r()).then(function(){t.taskQueue.length?t.processTaskQueue(e):t.advance()})}else g(function(){t.advance()})}}},{key:"advanceTestQueue",value:function(){if(W.blocking||W.queue.length||0!==W.depth){var e=W.queue.shift()
...
this.finished=!0,we("runEnd",se.end(!0)),_e("done",{passed:r,failed:W.stats.bad,total:W.stats.all,runtime:n}).then(function(){if(t&&0===W.stats.bad)for(var e=t.length-1;e>=0;e--){var n=t.key(e)
0===n.indexOf("qunit-test-")&&t.removeItem(n)}})}}])
function lt(e){W.current?W.current.assert.pushResult({result:!1,message:"global failure: ".concat(A(e)),source:e&&e.stack||ge(2)}):(se.globalFailureCount++,W.stats.bad++,W.stats.all++,we("error",e))}function ct(){}var ft=-1,dt=Object.prototype.hasOwnProperty
...
return s&&a.unshift([0,s]),o&&a.push([0,o]),this.diffCleanupMerge(a),a},ct.prototype.diffCleanupEfficiency=function(e){var t,n,r,i,s,o,a,u,l
for(t=!1,n=[],r=0,i=null,s=0,o=!1,a=!1,u=!1,l=!1;s<e.length;)0===e[s][0]?(e[s][1].length<4&&(u||l)?(n[r++]=s,o=u,a=l,i=e[s][1]):(r=0,i=null),u=l=!1):(e[s][0]===ft?l=!0:u=!0,i&&(o&&a&&u&&l||i.length<2&&o+a+u+l===3)&&(e.splice(n[r-1],0,[ft,i]),e[n[r-1]+1][0]=1,r--,i=null,o&&a?(u=l=!0,r=0):(s=--r>0?n[r-1]:-1,u=l=!1),t=!0)),s++
t&&this.diffCleanupMerge(e)},ct.prototype.diffPrettyHtml=function(e){for(var t=[],n=0;n<e.length;n++){var r=e[n][0],i=e[n][1]
switch(r){case 1:t[n]="<ins>"+L(i)+"</ins>"
break
case ft:t[n]="<del>"+L(i)+"</del>"
break
case 0:t[n]="<span>"+L(i)+"</span>"}}return t.join("")},ct.prototype.diffCommonPrefix=function(e,t){var n,r,i,s
if(!e||!t||e.charAt(0)!==t.charAt(0))return 0
for(i=0,n=r=Math.min(e.length,t.length),s=0;i<n;)e.substring(s,n)===t.substring(s,n)?s=i=n:r=n,n=Math.floor((r-i)/2+i)
return n},ct.prototype.diffCommonSuffix=function(e,t){var n,r,i,s
...
return n},ct.prototype.diffCompute=function(e,t,n,r){var i,s,o,a,u,l,c,f,d,h,p,g
return e?t?(s=e.length>t.length?e:t,o=e.length>t.length?t:e,-1!==(a=s.indexOf(o))?(i=[[1,s.substring(0,a)],[0,o],[1,s.substring(a+o.length)]],e.length>t.length&&(i[0][0]=i[2][0]=ft),i):1===o.length?[[ft,e],[1,t]]:(u=this.diffHalfMatch(e,t))?(l=u[0],f=u[1],c=u[2],d=u[3],h=u[4],p=this.DiffMain(l,c,n,r),g=this.DiffMain(f,d,n,r),p.concat([[0,h]],g)):n&&e.length>100&&t.length>100?this.diffLineMode(e,t,r):this.diffBisect(e,t,r)):[[ft,e]]:[[1,t]]},ct.prototype.diffHalfMatch=function(e,t){var n,r,i,s,o,a,u,l,c,f
...
return 2*o.length>=e.length?[l,c,f,d,o]:null}return i=this,l=d(n,r,Math.ceil(n.length/4)),c=d(n,r,Math.ceil(n.length/2)),l||c?(f=c?l&&l[4].length>c[4].length?l:c:l,e.length>t.length?(s=f[0],u=f[1],a=f[2],o=f[3]):(a=f[0],o=f[1],s=f[2],u=f[3]),[s,u,a,o,f[4]]):null},ct.prototype.diffLineMode=function(e,t,n){var r,i,s,o,a,u,l,c,f
...
o+=r.length}a=0,u=0,c="",l=""}o++}return i.pop(),i},ct.prototype.diffBisect=function(e,t,n){var r,i,s,o,a,u,l,c,f,d,h,p,g,m,v,b,y,k,w,x,E,T,C
...
else if(!d&&(b=o+f-C)>=0&&b<a&&-1!==u[b]&&(w=o+(y=u[b])-b,y>=(k=r-k)))return this.diffBisectSplit(e,t,y,w,n)}}return[[ft,e],[1,t]]},ct.prototype.diffBisectSplit=function(e,t,n,r,i){var s,o,a,u,l,c
return s=e.substring(0,n),a=t.substring(0,r),o=e.substring(n),u=t.substring(r),l=this.DiffMain(s,a,!1,i),c=this.DiffMain(o,u,!1,i),l.concat(c)},ct.prototype.diffCleanupSemantic=function(e){for(var t,n,r,i,s=!1,o=[],a=0,u=null,l=0,c=0,f=0,d=0,h=0;l<e.length;)0===e[l][0]?(o[a++]=l,c=d,f=h,d=0,h=0,u=e[l][1]):(1===e[l][0]?d+=e[l][1].length:h+=e[l][1].length,u&&u.length<=Math.max(c,f)&&u.length<=Math.max(d,h)&&(e.splice(o[a-1],0,[ft,u]),e[o[a-1]+1][0]=1,a--,l=--a>0?o[a-1]:-1,c=0,f=0,d=0,h=0,u=null,s=!0)),l++
for(s&&this.diffCleanupMerge(e),l=1;l<e.length;)e[l-1][0]===ft&&1===e[l][0]&&(t=e[l-1][1],n=e[l][1],(r=this.diffCommonOverlap(t,n))>=(i=this.diffCommonOverlap(n,t))?(r>=t.length/2||r>=n.length/2)&&(e.splice(l,0,[0,n.substring(0,r)]),e[l-1][1]=t.substring(0,t.length-r),e[l+1][1]=n.substring(r),l++):(i>=t.length/2||i>=n.length/2)&&(e.splice(l,0,[0,t.substring(0,i)]),e[l-1][0]=1,e[l-1][1]=n.substring(0,n.length-i),e[l+1][0]=ft,e[l+1][1]=t.substring(i),l++),l++),l++},ct.prototype.diffCommonOverlap=function(e,t){var n=e.length,r=t.length
if(0===n||0===r)return 0
...
if(-1===u)return s
o+=u,0!==u&&e.substring(i-o)!==t.substring(0,o)||(s=o,o++)}},ct.prototype.diffLinesToChars=function(e,t){var n=[],r={}
function i(e){for(var t="",i=0,s=-1,o=n.length;s<e.length-1;){-1===(s=e.indexOf("\n",i))&&(s=e.length-1)
var a=e.substring(i,s+1)
i=s+1,dt.call(r,a)?t+=String.fromCharCode(r[a]):(t+=String.fromCharCode(o),r[a]=o,n[o++]=a)}return t}return n[0]="",{chars1:i(e),chars2:i(t),lineArray:n}},ct.prototype.diffCharsToLines=function(e,t){for(var n=0;n<e.length;n++){for(var r=e[n][1],i=[],s=0;s<r.length;s++)i[s]=t[r.charCodeAt(s)]
e[n][1]=i.join("")}},ct.prototype.diffCleanupMerge=function(e){e.push([0,""])
...
0!==o&&(t-n-r>0&&0===e[t-n-r-1][0]?e[t-n-r-1][1]+=s.substring(0,o):(e.splice(0,0,[0,s.substring(0,o)]),t++),s=s.substring(o),i=i.substring(o)),0!==(o=this.diffCommonSuffix(s,i))&&(e[t][1]=s.substring(s.length-o)+e[t][1],s=s.substring(0,s.length-o),i=i.substring(0,i.length-o))}0===n?e.splice(t-r,n+r,[1,s]):0===r?e.splice(t-n,n+r,[ft,i]):e.splice(t-n-r,n+r,[ft,i],[1,s]),t=t-n-r+(n?1:0)+(r?1:0)+1}else 0!==t&&0===e[t-1][0]?(e[t-1][1]+=e[t][1],e.splice(t,1)):t++
...
var ht={}
W.currentModule.suiteReport=se,W.pq=new ut(Oe)
var pt=!1,gt=!1
function mt(){gt=!0,g?g(function(){bt()}):bt()}function vt(){W.blocking=!1,W.pq.advance()}function bt(){if(W.started)vt()
else{W.reporters.console&&st.console.init(ht),W.reporters.tap&&st.tap.init(ht),W.started=_.now(),""===W.modules[0].name&&0===W.modules[0].tests.length&&W.modules.shift()
...
we("runStart",se.start(!0)),_e("begin",{totalTests:qe.count,modules:e}).then(vt)}}ht.isLocal=b&&b.location&&"file:"===b.location.protocol,ht.version="2.25.0",M(ht,{config:W,diff:function(e,t){var n,r
return r=(n=new ct).DiffMain(e,t),n.diffCleanupEfficiency(r),n.diffPrettyHtml(r)},dump:te,equiv:Y,reporters:st,hooks:at,is:R,objectType:I,on:function(e,t){if("string"!=typeof e)throw new TypeError("eventName must be a string when registering a listener")
if(!q(e,ye)){var n=ye.join(", ")
...
return t.stack=e.stacktrace||e.fileName+":"+e.lineNumber,lt(t),!1},onUncaughtException:lt,pushFailure:Ne,assert:me.prototype,module:fe,test:Oe,todo:Oe.todo,skip:Oe.skip,only:Oe.only,start:function(e){if(W.current)throw new Error("QUnit.start cannot be called inside a test context.")
var t=pt
if(pt=!0,gt)throw new Error("Called start() while test already started running")
...
if(!W.pageLoaded)return W.autostart=!0,void(y||ht.autostart())
mt()},onUnhandledRejection:function(e){ne.warn("QUnit.onUnhandledRejection is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),lt(e)},extend:function(){ne.warn("QUnit.extend is deprecated and will be removed in QUnit 3.0. Please use Object.assign instead.")
for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
return M.apply(this,t)},load:function(){ne.warn("QUnit.load is deprecated and will be removed in QUnit 3.0. https://qunitjs.com/api/QUnit/load/"),ht.autostart()},autostart:function(){W.pageLoaded=!0,M(W,{started:0,updateRate:1e3,autostart:!0,filter:""},!0),gt||(W.blocking=!1,W.autostart&&mt())},stack:function(e){return ge(e=(e||0)+2)}}),function(e){var t=["begin","done","log","testStart","testDone","moduleStart","moduleDone"]
...
void 0===W.callbacks[i]&&(W.callbacks[i]=[]),e[i]=n(i)}}(ht),function(i){if(b&&y){if(b.QUnit&&b.QUnit.version)throw new Error("QUnit has already been defined.")
b.QUnit=i}e&&e.exports&&(e.exports=i,e.exports.QUnit=i),t&&(t.QUnit=i),void 0===(r=function(){return i}.call(t,n,t,e))||(e.exports=r),i.config.autostart=!1}(ht),function(){if(b&&y){var e=ht.config,t=Object.prototype.hasOwnProperty
...
var yt={exports:{}}
!function(e){var t,n
t=xe,n=function(){var e=void 0!==Ee&&"undefined"==typeof window,t="function"==typeof Map?Map:function(){var e=Object.create(null)
...
var kt=yt.exports,wt={failedTests:[],defined:0,completed:0}
!function(){if(b&&y){ht.reporters.perf.init(ht)
var e=ht.config,t=[],n=!1,r=Object.prototype.hasOwnProperty,i=S({filter:void 0,module:void 0,moduleId:void 0,testId:void 0}),s=null
ht.on("runStart",function(e){wt.defined=e.testCounts.total}),ht.begin(function(t){!function(t){var n,o,a,u,c,p,g,w,S=E("qunit")
S&&(S.setAttribute("role","main"),S.innerHTML="<h1 id='qunit-header'>"+L(y.title)+"</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar' role='navigation'></div>"+(!(n=ht.config.testId)||n.length<=0?"":"<div id='qunit-filteredTest'>Rerunning selected tests: "+L(n.join(", "))+" <a id='qunit-clearFilter' href='"+L(i)+"'>Run all tests</a></div>")+"<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"),(o=E("qunit-header"))&&(o.innerHTML="<a href='"+L(i)+"'>"+o.innerHTML+"</a> "),(a=E("qunit-banner"))&&(a.className=""),g=E("qunit-tests"),(w=E("qunit-testresult"))&&w.parentNode.removeChild(w),g&&(g.innerHTML="",(w=y.createElement("p")).id="qunit-testresult",w.className="result",g.parentNode.insertBefore(w,g),w.innerHTML='<div id="qunit-testresult-display">Running...<br />&#160;</div><div id="qunit-testresult-controls"></div><div class="clearfix"></div>',c=E("qunit-testresult-controls")),c&&c.appendChild(((p=y.createElement("button")).id="qunit-abort-tests-button",p.innerHTML="Abort",f(p,"click",T),p)),(u=E("qunit-userAgent"))&&(u.innerHTML="",u.appendChild(y.createTextNode("QUnit "+ht.version+"; "+k.userAgent))),function(t){var n,i,o,a,u,c=E("qunit-testrunner-toolbar")
...
var a=L(o.id),u=L(o.tooltip)
if(o.value&&"string"!=typeof o.value){if(i+="<label for='qunit-urlconfig-"+a+"' title='"+u+"'>"+L(o.label)+": <select id='qunit-urlconfig-"+a+"' name='"+a+"' title='"+u+"'><option></option>",Array.isArray(o.value))for(var l=0;l<o.value.length;l++)i+="<option value='"+(a=L(o.value[l]))+"'"+(e[o.id]===o.value[l]?(t=!0)&&" selected='selected'":"")+">"+a+"</option>"
else for(var c in o.value)r.call(o.value,c)&&(i+="<option value='"+L(c)+"'"+(e[o.id]===c?(t=!0)&&" selected='selected'":"")+">"+L(o.value[c])+"</option>")
e[o.id]&&!t&&(i+="<option value='"+(a=L(e[o.id]))+"' selected='selected' disabled='disabled'>"+a+"</option>"),i+="</select></label>"}else i+="<label for='qunit-urlconfig-"+a+"' title='"+u+"'><input id='qunit-urlconfig-"+a+"' name='"+a+"' type='checkbox'"+(o.value?" value='"+L(o.value)+"'":"")+(e[o.id]?" checked='checked'":"")+" title='"+u+"' />"+L(o.label)+"</label>"}return i}(),m(u,"qunit-url-config"),h(u.getElementsByTagName("input"),"change",_),h(u.getElementsByTagName("select"),"change",_),u))
...
s.selectedMap.has(r.moduleId)||(t+=N(r.moduleId,r.name,!1))}return t}(""===e?s.options.slice(0,20).map(function(e){return{obj:e}}):kt.go(e,s.options,{limit:20,key:"name",allowTypo:!0}))}(o.value)})}function S(e){var t=e&&e.target||null
...
g.className="clearfix",c.appendChild(p),c.appendChild(g)}}(t)}(t)}),ht.on("runEnd",function(t){var n,r,i,s=E("qunit-banner"),o=E("qunit-tests"),a=E("qunit-abort-tests-button"),u=e.stats.all-e.stats.bad,l=[t.testCounts.total," tests completed in ",t.runtime," milliseconds, with ",t.testCounts.failed," failed, ",t.testCounts.skipped," skipped, and ",t.testCounts.todo," todo.<br />","<span class='passed'>",u,"</span> assertions of <span class='total'>",e.stats.all,"</span> passed, <span class='failed'>",e.stats.bad,"</span> failed.",I(wt.failedTests)].join("")
if(a&&a.disabled){l="Tests aborted after "+t.runtime+" milliseconds."
for(var c=0;c<o.children.length;c++)""!==(n=o.children[c]).className&&"running"!==n.className||(n.className="aborted",i=n.getElementsByTagName("ol")[0],(r=y.createElement("li")).className="fail",r.innerHTML="Test aborted.",i.appendChild(r))}!s||a&&!1!==a.disabled||(s.className="failed"===t.status?"qunit-fail":"qunit-pass"),a&&a.parentNode.removeChild(a),o&&(E("qunit-testresult-display").innerHTML=l),e.altertitle&&y.title&&(y.title=["failed"===t.status?"✖":"✔",y.title.replace(/^[\u2714\u2716] /i,"")].join(" ")),e.scrolltop&&b.scrollTo&&b.scrollTo(0,0)}),ht.testStart(function(e){var t,n
j(e.name,e.testId,e.module),(t=E("qunit-testresult-display"))&&(m(t,"running"),n=ht.config.reorder&&e.previousFailure,t.innerHTML=[O(wt),n?"Rerunning previously failed test: <br />":"Running: ",R(e.name,e.module),I(wt.failedTests)].join(""))}),ht.log(function(e){var t=E("qunit-test-output-"+e.testId)
if(t){var n,r,i,s=L(e.message)||(e.result?"okay":"failed")
s="<span class='test-message'>"+s+"</span>",s+="<span class='runtime'>@ "+e.runtime+" ms</span>"
var o=!1
e.result||void 0===e.expected&&void 0===e.actual?!e.result&&e.source&&(s+="<table><tr class='test-source'><th>Source: </th><td><pre>"+L(e.source)+"</pre></td></tr></table>"):(n=e.negative?"NOT "+ht.dump.parse(e.expected):ht.dump.parse(e.expected),r=ht.dump.parse(e.actual),s+="<table><tr class='test-expected'><th>Expected: </th><td><pre>"+L(n)+"</pre></td></tr>",r!==n?(s+="<tr class='test-actual'><th>Result: </th><td><pre>"+L(r)+"</pre></td></tr>","number"==typeof e.actual&&"number"==typeof e.expected?isNaN(e.actual)||isNaN(e.expected)||(o=!0,i=((i=e.actual-e.expected)>0?"+":"")+i):"boolean"!=typeof e.actual&&"boolean"!=typeof e.expected&&(o=U(i=ht.diff(n,r)).length!==U(n).length+U(r).length),o&&(s+="<tr class='test-diff'><th>Diff: </th><td><pre>"+i+"</pre></td></tr>")):-1!==n.indexOf("[object Array]")||-1!==n.indexOf("[object Object]")?s+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the depth of object is more than current max depth ("+ht.dump.maxDepth+").<p>Hint: Use <code>QUnit.dump.maxDepth</code> to  run with a higher max depth or <a href='"+L(S({maxDepth:0}))+"'>Rerun without max depth</a>.</p></td></tr>":s+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the expected and actual results have an equivalent serialization</td></tr>",e.source&&(s+="<tr class='test-source'><th>Source: </th><td><pre>"+L(e.source)+"</pre></td></tr>"),s+="</table>")
var a=t.getElementsByTagName("ol")[0],u=y.createElement("li")
u.className=e.result?"pass":"fail",u.innerHTML=s,a.appendChild(u)}}),ht.testDone(function(r){var i=E("qunit-tests"),s=E("qunit-test-output-"+r.testId)
if(i&&s){var o
...
c?m(a,"qunit-collapsed"):(wt.failedTests.push(r.testId),e.collapse&&(n?m(a,"qunit-collapsed"):n=!0))
var d=s.firstChild,h=l?"<b class='failed'>"+l+"</b>, <b class='passed'>"+u+"</b>, ":""
if(d.innerHTML+=" <b class='counts'>("+h+r.assertions.length+")</b>",wt.completed++,r.skipped){s.className="skipped"
...
k.innerHTML="<strong>Source: </strong>"+L(r.source),m(k,"qunit-source"),c&&m(k,"qunit-collapsed"),f(d,"click",function(){v(k,"qunit-collapsed")}),s.appendChild(k)}e.hidepassed&&("passed"===o||r.skipped)&&(t.push(s),i.removeChild(s))}}),ht.on("error",function(e){var t=j("global failure")
if(t){var n=L(A(e))
...
for(var i in e=M(M({},ht.urlParams),e))if(r.call(e,i)&&void 0!==e[i])for(var s=[].concat(e[i]),o=0;o<s.length;o++)t+=encodeURIComponent(i),!0!==s[o]&&(t+="="+encodeURIComponent(s[o])),t+="&"
return n.protocol+"//"+n.host+n.pathname+t.slice(0,-1)}function q(){var e=E("qunit-filter-input").value
b.location=S({filter:""===e?void 0:e,moduleId:l(s.selectedMap.keys()),module:void 0,testId:void 0})}function N(e,t,n){return'<li><label class="clickable'+(n?" checked":"")+'"><input type="checkbox" value="'+L(e)+'"'+(n?' checked="checked"':"")+" />"+L(t)+"</label></li>"}function j(e,t,n){var r=E("qunit-tests")
...
return a.className="qunit-assert-list",s.appendChild(a),r.appendChild(s),s}}function I(e){return 0===e.length?"":["<br /><a href='"+L(S({testId:e}))+"'>",1===e.length?"Rerun 1 failed test":"Rerun "+e.length+" failed tests","</a>"].join("")}function R(e,t){var n=""
return t&&(n="<span class='module-name'>"+L(t)+"</span>: "),n+"<span class='test-name'>"+L(e)+"</span>"}function O(e){return[e.completed," / ",e.defined," tests completed.<br />"].join("")}function U(e){return e.replace(/<\/?[^>]+(>|$)/g,"").replace(/&quot;/g,"").replace(/\s+/g,"")}}()}()}}])
